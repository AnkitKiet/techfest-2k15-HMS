...
$sql="SELECT * FROM attendence WHERE `date`='$q' AND attendence='A' AND hostel_id='$h' ORDER BY `room` ASC";
...
while($row=mysql_fetch_array($result_set))
{
  ...
  $ida=$row['student_id'];
  $r=$row['room'];
  $results=mysql_query("SELECT * FROM `login` WHERE `id` = '$ida' AND hostel_id='$h'");
