		...
		<div id="main">
			<div id="content" class="container">
				<section>
					<header>
					<center>
						<span class="byline">Enter Filters</span>
					</header>
					<p>
...
<table><tr><td align=center>FROM:</td><td><input type='textbox' name='from' placeholder='YYYY-MM-DD' id="from"><script>
    $(function() {
        $("#from").calendricalDate({
            iso: 1,
        });
    });
</script></td><td align=center>TO:</td><td><input type='textbox' name='to' placeholder='YYYY-MM-DD' id='to'>
<script>
    $(function() {
        $("#to").calendricalDate({
            iso: 1,
...
<tr><td colspan=4 align=center>Roll No. <input type='textbox' name='roll' placeholder='Roll No'></td></tr>
<tr><td>&nbsp</td><td>&nbsp</td><td>&nbsp</td><td>&nbsp</td></tr>
<tr><td colspan=4 align=center><input type=submit value=Submit class="btn"></td></tr>
</table>
</center>
</form>
    </body>
