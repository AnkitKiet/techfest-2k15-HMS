...
<body>
<center>
<form action="updateattendence.php" method="POST">
<table><tr><td>Date:</td><td><INPUT TYPE="text" name="day" placeholder="yyyy-mm-dd" id="to"><script>
    $(function() {
        $("#to").calendricalDate({
            iso: 1,
        });
...
<tr><td colspan=2 align="center"><INPUT TYPE="submit" name="SUBMIT" class="btn" value="submit"></td></tr></table>
</center> <BR><BR><BR><BR>
</form>
    </body>
